...
public class PozoristeForma extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PozoristeForma frame = new PozoristeForma();
...
table.addMouseListener(new MouseAdapter() {
		...
		lblNewLabel.setBounds(49, 42, 46, 14);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Adresa");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel_1.setBounds(357, 42, 79, 14);
		contentPane.add(lblNewLabel_1);
		
		tfNaziv = new JTextField();
		tfNaziv.setBounds(105, 39, 224, 20);
		contentPane.add(tfNaziv);
		tfNaziv.setColumns(10);
		
		tfAdresa = new JTextField();
		tfAdresa.setBounds(446, 39, 167, 20);
